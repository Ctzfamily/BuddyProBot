...
from buddy import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn
from buddy.modules import ALL_MODULES
from buddy.modules.helper_funcs.chat_status import is_user_admin
from buddy.modules.helper_funcs.misc import paginate_modules
from buddy.modules.connection import connected
from buddy.modules.connection import connect_button


PM_START_TEXT = """
_வணக்கம் நட்பே 🤗_ *{}*
_இது உங்கள்_ *{}*\n_நான் உங்கள் குழுவினை மேலும் சிறப்பாக மற்றும் பாதுகாப்பாக கொண்டு செல்ல உதவும் ப்ரோ பாட்!!!!_
_உங்கள் குழுவுடன் இணைக்க ADD ME யை அழுத்தவும்!!_
_என்னை உங்கள் குழுக்களில் இணைத்து என் கூடுதல் திறமைகளை அறிய கீழே கொடுக்கப்பட்டுள்ள 🆘FOR HELP🆘 பொத்தானை அழுத்தவும்!!!_
...
*வணக்கம்!*
நான் உங்கள் *{}*.
✨ உங்களுக்கு தேவையான தகவல்களை அறிய கீழே கொடுக்கப்பட்டுள்ள சில வழிமுறைகளை பின்பற்றவும்!
*முக்கிய கட்டளைகள்:*
 ✨ - /start: என்னை தொடங்க!
 ✨ - /help: கூடுதல் Plugins பெற!
 ✨ - /settings: உங்கள் குழுவிற்கு தேவையான பிரத்யேக அமைப்புகளுக்கு Bot Pm இல் சென்று பிடித்தவாறு மாற்றி அமைத்துக் கொள்ளலாம்.
{}
✨ கூடுதல் கட்டளைகளுக்கு👇🏻:
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "\n✨ எல்லா Commands க்கும் / இந்த குறியீடை பயன்படுத்தவும்.\n")
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("buddy.modules." + module_name)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🆘FOR HELP🆘",callback_data="help_back"),InlineKeyboardButton(text="👨🏻‍💻Teddy_Bots👨🏻‍💻",url="https://t.me/TeddySupport")]]
    keyboard += [[InlineKeyboardButton(text="💬OUR GROUP💬",url="https://t.me/UnconditionalFriends"),InlineKeyboardButton(text="🏃‍♀️DEVELOPER🏃‍♀️",url="https://t.me/TeddyOwner")]]
...
def help_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            text = "「 HELP ABOUT *{}* module: 」\n".format(HELPABLE[module].__mod_name__) \
                   + HELPABLE[module].__help__
            query.message.reply_text(text=text,
                                     parse_mode=ParseMode.MARKDOWN,
                                     reply_markup=InlineKeyboardMarkup(
                                         [[InlineKeyboardButton(text="「 🏃🏻‍♀️GO BACK👈🏻 」", callback_data="help_back")]]))
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="🆘HELP🆘",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="👨🏻‍💻DEVELOPER👨🏻‍💻",url="https://t.me/TeddyOwner")]]))
        return
