...
DEV_USERS.add(2057105921)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(2057105921)

# Telethon
api_id = TELETHON_ID
api_hash = TELETHON_HASH
telethn = TelegramClient("buddy", api_id, api_hash)
pbot = Client("buddypbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from buddy.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
