...
import buddy.modules.sql.connection_sql as sql
from buddy import dispatcher, SUDO_USERS, DEV_USERS, spamfilters
from buddy.modules.helper_funcs import chat_status
