...
from buddy.modules.helper_funcs.msg_types import Types
from buddy.modules.sql import SESSION, BASE

DEFAULT_WELCOME = "வணக்கம் {first}, வெல்கம் TO {chatname}! நலமாக இருக்கிறீர்களா?"
DEFAULT_GOODBYE = "ஆழ்ந்த அனுதாபங்கள்!"
