...
from buddy.modules.sql import afk_sql as sql
from buddy.modules.users import get_user_id
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        ...
        try:        
            ...
            "{} is back online!",
            "{} I am back!",
            "{} மீண்டும் வந்து விட்டார்!",
            "{} திரும்பி வந்துட்டேன்னு சொல்லு🙈",
            "{} நானும் இங்கதா இருக்கேன்🚶🏻🚶🏻‍♀️!",
            "{} என்னடா நடக்குது இங்க?👀",
            "{} வாடா என் பம்பரக்கா மண்டையா?🤯",
            "{} நா இல்லாம ரொம்ப சந்தோஷமா இருக்கீங்க போல?😔",
            "{} is back!",
            "{} is now in the chat!",
            "{} is awake!",
            "{} is back online!",
